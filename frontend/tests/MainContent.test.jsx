...
const { mockGetProductsByCategory } = vi.hoisted(() => ({ mockGetProductsByCategory: vi.fn() }))
...
vi.mock('../src/components/Breadcrumb/Breadcrumb', () => ({
  default: ({ categoryName, showProducts, showProductDetail, productName, onHomeClick, onBackToCategory, onBackToProducts }) => (
